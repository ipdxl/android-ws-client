 ...
 * 2012-05-04T19:38:31.670+06:00
 * Generated source version: 2.5.1
 * 
 */
@WebServiceClient(name = "LoginService", 
                  wsdlLocation = "http://116.68.194.105:9010/LoginService?WSDL",
...
public class LoginService extends org.jinouts.ws.JinosService {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://116.68.194.105:9010/LoginService?WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(LoginService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://116.68.194.105:9010/LoginService?WSDL");
        }
        WSDL_LOCATION = url;
    }
