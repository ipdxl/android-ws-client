 ...
 * 
 */
@WebService(serviceName = "AndProxyClientRespTestWS", name = "AndProxyClientRespTestWS", targetNamespace = "http://ws.jinouts.org/")
public class AndProxyClientRespTestWS
{
	@WebMethod
